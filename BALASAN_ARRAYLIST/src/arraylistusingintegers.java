...
import java.util.*;
public class arraylistusingintegers
{
    public static void main(String[] args)
    {
        ...
        ArrayList<Integer> al2 = new ArrayList<>(Arrays.asList(9,10,11,12,13));
        al.addAll(al2);
...
//          al3.clear();
        ...
        ArrayList<Integer> trimarray = new ArrayList<>();
        trimarray.add(1);
        trimarray.add(2);
        trimarray.add(3);
        trimarray.add(4);
        ...
        //Using list iterator
        ListIterator i = trimarray.listIterator();
